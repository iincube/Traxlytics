...
public class TraxlyticsProvider extends ContentProvider {
  private static final String TAG = TraxlyticsProvider.class.getSimpleName();

  private TraxlyticsDBHelper dbHelper;
  ...
  public boolean onCreate() {
    ...
    dbHelper = new TraxlyticsDBHelper(getContext(), LocalStoreContract.CREATE_TABLE_QUERIES,
